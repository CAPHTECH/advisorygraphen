...
| `AdvisoryProjection` | `Projection` | 経営者、開発者、監査、AI、Todoist 向けビュー |
...
| `structure_to_projection` | executive / developer / audit / AI / Todoist view へ変換する |
...
8. Todoist export は projection であり、AdvisoryGraphen の source of truth ではない。
