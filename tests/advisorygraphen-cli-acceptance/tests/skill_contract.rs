...
fn repository_skill_documents_agent_resume_protocol() {
    ...
    for required in [
        ...
        "advisorygraphen propose --input",
        "advisorygraphen status --case",
        "advisorygraphen report --case",
        "advisorygraphen review completion accept|reject",
...
fn pr_review_skill_documents_micro_review_structure_risk_triage() {
    ...
    for required in [
        ...
        "micro-review.json",
        "advisorygraphen.micro_review.request.v1",
        "obstructions",
        "claim_marked_supported_without_evidence",
        "required_resolution",
